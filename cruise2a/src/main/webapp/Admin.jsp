...
<head>
    ...
    <script>
        ...
        alert('Successfully update record Based on IC Number');
        }
...
<div class="container">
    ...
    <form action="add_Client.php" method="post" onsubmit="displayPopup()">
    ...
    <form action="delete_user.php" method="post" onsubmit="displayPopup1()">
        <center><input type="text" name="username" placeholder="Username to delete" required></center>
        <button type="submit" class="button">Delete User</button>
    </form><br><br>


    <form action="edit_user.php" method="post" onsubmit="displayPopup2()">
        <input type="text" name="Name" placeholder="Name" required>&nbsp;&nbsp;&nbsp;
        <input type="icNo" name="IC_Number" placeholder="IC Number" required>&nbsp;&nbsp;&nbsp;
        <input type="Date" name="Check_In" placeholder="Check In" required>&nbsp;&nbsp;&nbsp;
        <input type="Date" name="Check_Out" placeholder="Check Out" required>&nbsp;&nbsp;&nbsp;
